...
GENIE applies the psychometric reduction steps present in `AIGENIE` on
user-supplied items. Users provide their own items and optionally their
own embeddings, then `GENIE` performs redundancy reduction and
...
- jina.API:
  ...
  Jina AI API key for using Jina embedding models (e.g.,
  "jina-embeddings-v3"). Free tier available at <https://jina.ai/>.
...
- embedding.model:
  ...
  - HuggingFace: "BAAI/bge-base-en-v1.5", "BAAI/bge-small-en-v1.5",
    "sentence-transformers/all-MiniLM-L6-v2"

- EGA.model:

  EGA network estimation model ("glasso", "TMFG", or NULL for
  auto-selection)
